...
def page_histori():
    ...
    if search_code:
        ...
        df_tx = df_tx.rename(columns={"code":"Kode","used_amount":"Jumlah","tanggal_transaksi":"Tanggal_transaksi","branch":"Cabang","items":"Menu"})
        st.dataframe(df_tx[["Kode","Tanggal_transaksi","Jumlah","Cabang","Menu"]], use_container_width=True)
