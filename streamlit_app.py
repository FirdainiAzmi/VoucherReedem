        ...
        if df_tx.empty:
            ...
            try:
                ...
                # Jika tidak ada kode yang dicari
                    ...
                    st.dataframe(df_tx[["Tanggal_transaksi", "kupon digunakan", "Kode", "Saldo kupon digunakan"]], use_container_width=True)
                    st.download_button(
            ...
            if st.button("Cek Kupon"):
                ...
                if not code:
                    ...
                    if not row:
                        ...
                        elif status_normalized == "habis" or balance <= 0:
